...
<%--가끔 에러가 발생하는데 언더바 알티 _rt 를 쓰면 좋다--%>
<%@ page session="true"%>
...
<%--    외부 자바스크립트 라이브러리를 로드하는데 사용된다. src 속성에는 외부 자스파일의 url을 지정하고 제이쿼리 1.11.3. 을 로드하고 있다.--%>
    <style>
        * {
        ...
        textarea {
            ...
            border: 1px solid #e9e8e8;
            resize: none;
            /*요소의 크기 조정(resizing) 기능을 비활성화하는 역할*/
            padding: 8px;
            outline-color: #e6e6e6;
        }
        .frm {
...
<div id="menu">
    <ul>
        ...
        <li><a href="<c:url value='/board/list'/>">상담 예약</a></li>
